...
export function ThreeDCardDemo({ who }: ThreeDCardDemoProps){
    ...
    return (
        <CardContainer className="inter-var">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black w-auto sm:max-w-[30rem] h-auto rounded-xl p-6 border grid gap-2">
                <CardItem
                    translateZ="50"
