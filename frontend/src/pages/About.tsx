import { BadgeIndianRupee, HandHeart, MailIcon, UsersRound } from "lucide-react";
            ...
            <div className="grid w-full">
                ...
                <div className="grid place-content-center mt-10">
                    ...
                    <div className="grid place-content-center">
                        <p className="text-[2em] md:text-[3em] font-serif">
                            Arogy<span className="text-orange-500">Arpan</span>
                        </p>
                    </div>
                    {/* Tag line */}
                    <div className="font-mono grid place-content-center">
                        <p>Your Support, Their Lifeline</p>
                    </div>
                    {/* Description */}
                ...
                <div className="bg-slate-100 mt-10 p-5">
                    ...
                    <div className="grid place-content-center  p-5 gap-8">
                        <div className="w-full grid place-content-center gap-4">
                            <div className="grid place-content-center shadow-md py-4 px-6 rounded-md">
                                <div className="w-full grid place-content-center">
                                    <BadgeIndianRupee />
                                </div>
                                <div className="text-black text-md font-bold flex justify-center">
                                    &nbsp;&#8377;
                                    {"20000"}
                                </div>
                                <div className="text-black text-md font-bold w-full grid place-content-center">
                                    + Raised
                                </div>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 place-content-center w-full gap-6">
                            <div className="grid place-content-center border shadow-md p-4 rounded-md">
                                <div className="w-full grid place-content-center">
                                    <HandHeart />
                                </div>
                                <div className="text-black text-md font-bold flex justify-center">
                        ...
                        <div className="Bborder flex w-full p-5 rounded-xl gap-2">
                            ...
                            <div className=" grid md:p-5 gap-1 md:gap-2">
                                ...
                                <div className="grid border rounded-md">
                                    <div className="flex gap-2 w-full md:m-2 md:gap-3 py-1 px-2">
                                        {social.map((s) => (
                                            <div key={s.name}>
...
const social: SocialType[] = [
    ...
    },
    {
        ...
        icon: <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" height={20}>
            <path
                fill="currentColor"
    ...
    },
    {
        ...
        icon: <svg viewBox="0 0 438.549 438.549" height={20}>
            <path
                fill="currentColor"
    ...
    },
    {
        ...
        icon: <svg viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" height={20}>
    ...
    },
    {
        ...
        icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-instagram" height={20}>
